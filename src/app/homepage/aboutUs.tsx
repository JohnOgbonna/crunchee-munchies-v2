        ...
        <div className="bg-[#f5e3c5]">
            <div className={`p-4 flex flex-col items-center justify-center gap-4 mb-4 md:flex-row md:flex-wrap min-h-[400px] h-[70vh] md:max-h-[600px] w-full max-w-[1440px] mx-auto lg:min-h-[500px]`}>
                ...
                <div className="w-full flex flex-col items-center justify-center lg:text-[1.2rem]">
                    ...
                    <p className="w-full max-w-[600px]">We beleive we make the best Chin-Chin in the world and we want to share it with you- And then with the world! With our special recipie that we refined to perfection, we've recieved rave customer reviews. We're based in Calgary, Alberta and we're expanding our market!</p>
                </div>
